...
Create an AI decision evidence record.
Generate a cryptographic receipt for that action.
Verify the receipt through the CooL evidence layer.
Detect tampering after the evidence has been created.
Review previously created evidence in Verification History.
